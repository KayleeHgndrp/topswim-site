...
function HeroOverlay({ lang, openSignup }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative z-[2] mx-auto grid min-h-0 w-full max-w-[1440px] flex-1 grid-rows-[minmax(0,2.28fr)_auto_minmax(0,0.86fr)] px-7 pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))] pt-8 max-md:px-[18px] md:pb-10 md:pt-10">
